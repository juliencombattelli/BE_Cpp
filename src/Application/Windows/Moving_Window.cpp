...
Moving_Window::Moving_Window(Picaso::Serial_Commander& lcd) :
	Window_Template(lcd),
...
void Moving_Window::button_pressing_handler(Sender& s, const Event& e)
{
	unsigned int button_id = static_cast<Picaso::Widget&>(s).get_id();
